<div class="container-fluid">
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="panel-title">
				<a href="#" data-toggle="collapse" data-target="#moreinfo-smswebhook" aria-expanded="true"><i class="glyphicon glyphicon-info-sign"></i></a>&nbsp;&nbsp;&nbsp;<?php echo _('What is SMS Web Hooks ?') ?>
			</div>
		</div>
	...
	<div class="display full-border">
				...
				<div class="fpbx-container">
					<form class="fpbx-submit" name="frm_sms_web_hooks" action="" method="post" role="form">
						<form autocomplete="off" name="edit" action="" method="post" onsubmit="return edit_onsubmit();">
							<?php echo load_view(__DIR__ . '/grid.php', array('settings' => $settings)); ?>
						</form>
					</form>
				</div>
			</div>
		...
		<!-- Grid -->
		<!--Modals-->
		<?php echo load_view(__DIR__ . '/form.php', array()); ?>
		<!--Modals-->
	</div>
</div>
</div>