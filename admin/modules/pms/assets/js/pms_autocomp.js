...
function FindGuest(find_guest)
{
	...
	if(find_guest.length == 0) {
		...
		$('#suggestions').hide();
              ...
              {
				request("ajax.php?module=pms",arrAction, true, function(arrData,statusResponse,error)
					{
...
function fill(thisValue) {
    ...
    if(thisValue){
    	request("ajax.php?module=pms",arrAction, false, function(arrData,statusResponse,error)
		{
			var result  = $.parseJSON(arrData);
