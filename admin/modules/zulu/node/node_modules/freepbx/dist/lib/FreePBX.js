...
var _astman = require('@freepbx/astman');

var _astman2 = _interopRequireDefault(_astman);
...
var FreePBX = exports.FreePBX = function () {
	...
	_createClass(FreePBX, [{
		...
		value: function AMIConnect(_ref8) {
			...
			return new _bluebird.Promise(function (resolve, reject) {
				var astman = new _astman2.default(config.configs.ASTMANAGERPORT, config.configs.ASTMANAGERHOST, config.configs.AMPMGRUSER, config.configs.AMPMGRPASS, true);
