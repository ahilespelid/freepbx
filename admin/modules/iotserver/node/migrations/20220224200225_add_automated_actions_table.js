exports.up = knex => knex.schema.createTable('automated_actions', (table) => {
	table.increments('id').primary().unsigned().notNullable();
    table.string('name', 64).notNullable().unique();
    table.string('type', 20).notNullable();
    table.string('desired_state', 16).notNullable().index();
...
exports.down = knex => knex.schema.dropTable('automated_actions');