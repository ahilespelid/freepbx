 ...
 * @type Extension
 */
const ZonePermission = PermissionModel.extend({
    tableName: 'zone_permissions',
    hasTimestamps: ['createdAt', 'updatedAt'],
    schema: {
	    id: Joi.number().integer(),
        zone_uuid: Joi.string().when('$creating',required),
...
module.exports =  bookshelf.model('zone_permission', ZonePermission)