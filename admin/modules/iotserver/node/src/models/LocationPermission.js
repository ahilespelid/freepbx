 ...
 * @type Extension
 */
const LocationPermission = PermissionModel.extend({
    tableName: 'location_permissions',
    hasTimestamps: ['createdAt', 'updatedAt'],
    schema: {
	    id: Joi.number().integer(),
        location_uuid: Joi.string().when('$creating',required),
...
module.exports =  bookshelf.model('location_permission', LocationPermission)